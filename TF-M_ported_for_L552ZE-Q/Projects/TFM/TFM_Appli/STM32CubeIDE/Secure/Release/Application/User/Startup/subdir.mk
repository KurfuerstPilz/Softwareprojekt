...
Application/User/Startup/startup_stm32l5xx_s.o: ../Application/User/Startup/startup_stm32l5xx_s.S
	arm-none-eabi-gcc -mcpu=cortex-m33 -c  -x assembler-with-cpp -MMD -MP -MF"Application/User/Startup/startup_stm32l5xx_s.d" -MT"$@" --specs=nano.specs -mfpu=fpv5-sp-d16 -mfloat-abi=softfp -mthumb -o "$@" "$<"
